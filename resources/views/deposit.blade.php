                ...
                <div class="nk-content-body">
                    <div class="nk-block-head nk-block-head-lg">
                        <div class="nk-block-head-content">
                            ...
                            <div class="nk-block-head-content">
                                <h2 class="nk-block-title fw-normal">Deposit Funds Into Your Wallet</h2>
                            </div>
                        </div>
                    </div><!-- nk-block-head -->
                    <div class="nk-block invest-block">
                        <form action="{{ route('deposit.store') }}" method="post" class="invest-form">
                            @csrf
                            <div class="row g-gs">
                                <div class="col-lg-7">
                                                        ...
                                                        <li class="invest-cc-item selected">
                                                            <button type="button"
                                                                ...
                                                                <div class="coin-item">
                                                                    <div class="coin-icon">
                                                                        <img width="30px"
                                                                            src="{{ $method->asset->image_url }}"
                                                                            alt="Icon">
                                                                    </div>
                                                                    <div class="coin-info">
                                                                        <span
                                                                            class="coin-name">{{ $method->asset->name }}</span>
                                                                        <span class="coin-text">Current Price:
                                                                            {{ $method->asset->symbol }} (
                                                                            {{ $method->asset->price }} )</span>
                                                                    </div>
                                                                </div>
                                                            </button>
                                                        </li><!-- .invest-cc-item -->
